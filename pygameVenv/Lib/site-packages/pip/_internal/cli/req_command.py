"""Contains the Command base resources that depend on PipSession.

The resources in this module are in a separate module so the commands not
...
class SessionCommandMixin(CommandContextMixIn):
    ...
    """
    A class mixin for command resources needing _build_session().
    """
    def __init__(self):
        # type: () -> None
