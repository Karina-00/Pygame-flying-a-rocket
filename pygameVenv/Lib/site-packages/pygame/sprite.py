...
"""pygame module with basic game object resources

This module contains several simple resources to be used within games. There
are the main Sprite class and several Group resources that contain Sprites.
The use of these resources is entirely optional when using Pygame. The resources
...
stores sprites. A game could create new types of Group resources that operate
...
membership.  The default initializers for these resources also take a
...
While it is possible to design sprite and group resources that don't derive
from the Sprite and AbstractGroup resources below, it is strongly recommended
...
class Sprite(object):
    ...
    The base class for visible game objects. Derived resources will want to
